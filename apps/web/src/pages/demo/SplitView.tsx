...
export function SplitView() {
    ...
    const leftPaneClass = `
        bg-white md:rounded-2xl overflow-hidden shadow-2xl border-neutral-800 flex flex-col md:max-w-[500px] transition-all duration-700 ease-in-out
    ...
    const rightPaneClass = `
        ...
        w-full md:flex-[1.5] h-full md:h-auto
    `;
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen w-full bg-neutral-950 md:p-4 gap-4 relative overflow-hidden">
            ...
            {/* Mobile View Toggler */}
            <div className="md:hidden fixed top-4 left-1/2 -translate-x-1/2 z-[100] bg-neutral-800/90 backdrop-blur border border-neutral-700 p-1 rounded-full flex gap-1 shadow-xl">
                <button
